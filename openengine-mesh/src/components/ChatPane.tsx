  ...
  return (
    <div className="flex flex-col h-full bg-[#080808] border-r border-[#1c1c1c] text-[#e0e0e0] font-sans">
      ...
      <div className="p-3 border-b border-[#1c1c1c] flex items-center justify-between bg-[#0b0b0b]">
        ...
        <div className="flex items-center space-x-1.5 text-xs bg-[#0e0e0e] border border-[#1f1f1f] px-2 py-1 rounded">
          ...
          <input
            ...
            className="bg-transparent text-[#d4d4d4] focus:outline-none w-36 font-mono text-[10px]"
      ...
      <div className="border-b border-[#171717] bg-[#0a0a0a] px-3 py-2 overflow-x-auto">
        <div className="flex items-center justify-between mb-1.5 text-[10px] font-mono text-[#525252]">
        ...
        <div className="flex items-center space-x-1.5 whitespace-nowrap">
          {quickUseCases.map((uc) => (
            <button
              ...
              className="flex items-center space-x-1 px-2 py-1 rounded bg-[#0f0f0f] hover:bg-[#171717] border border-[#1c1c1c] hover:border-[#2e2e2e] text-[10px] font-mono text-[#a3a3a3] hover:text-[#f5f5f5] transition-colors"
            >
              {uc.icon}
              <span>{uc.name}</span>
            </button>
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        <div className="text-[10px] font-mono text-[#525252] uppercase tracking-wider flex items-center space-x-1">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span
                    className={`px-1.5 py-0.5 rounded text-[9px] font-mono uppercase font-medium ${
                      run.status === 'running'
                ...
                {run.status === 'gated' && (
                  <button
                    ...
                    className="mt-2 w-full py-1 px-2 text-[10px] font-mono text-[#f5f5f5] bg-[#1c1c1c] hover:bg-[#262626] rounded border border-[#333333] transition-colors"
                  >
                    Review & Signoff Gate
                  </button>
                )}
      ...
      <form onSubmit={handleSubmit} className="p-3 border-t border-[#1c1c1c] bg-[#0a0a0a]">
        <div className="relative">
          <textarea
            ...
            rows={3}
            className="w-full text-xs p-2.5 rounded-lg bg-[#070707] border border-[#1c1c1c] text-[#e0e0e0] placeholder-[#525252] focus:outline-none focus:border-[#333333] resize-none leading-relaxed font-mono"
          />
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs font-mono font-medium text-[#f5f5f5] bg-[#1a1a1a] hover:bg-[#242424] border border-[#2e2e2e] disabled:opacity-40 transition-colors"
            >
