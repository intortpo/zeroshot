...
export const PetriDesignStudioView: React.FC = () => {
  ...
  const PALETTE_COMPONENTS = [
    ...
    {
      id: 'lupi_wave',
      name: 'Lupi Wave Manifold',
      category: 'Submersion',
      desc: 'Fifty Cohorts, One Wave ridge streamline with risk waterline',
      html: `\n<!-- Lieflat Lupi Editorial Wave -->\n<div class="p-6 bg-[#090D14] text-white rounded-3xl border border-stone-800 my-6 shadow-xl">\n  <div class="flex items-center justify-between border-b border-stone-800 pb-3 mb-4">\n    <div>\n      <span class="text-[10px] font-mono text-teal-400 font-bold uppercase tracking-wider">Lieflat Lupi Editorial</span>\n      <h3 class="text-sm font-bold text-stone-100">Fifty Cohorts, One Wave</h3>\n    </div>\n    <span class="text-[10px] font-mono text-stone-400 bg-stone-900 px-2 py-0.5 rounded-full border border-stone-800">Waterline: 0.0σ</span>\n  </div>\n  <div class="h-36 relative flex items-end justify-between px-2 overflow-hidden">\n    <div class="absolute inset-x-0 top-1/2 border-b border-dashed border-teal-500/60 z-10 flex items-center justify-between text-[9px] font-mono text-teal-400 px-1">\n      <span>RISK WATERLINE (Z = 0)</span>\n      <span>ELEVATION THRESHOLD</span>\n    </div>\n    <svg viewBox="0 0 500 120" class="w-full h-full">\n      <path d="M 0,80 Q 80,20 160,70 T 320,40 T 500,90 L 500,120 L 0,120 Z" fill="rgba(10,186,181,0.15)" />\n      <path d="M 0,80 Q 80,20 160,70 T 320,40 T 500,90" fill="none" stroke="#0ABAB5" stroke-width="2" />\n      <path d="M 0,95 Q 90,40 180,85 T 340,55 T 500,105" fill="none" stroke="#38BDF8" stroke-width="1.5" stroke-dasharray="2 3" />\n      <path d="M 0,105 Q 70,60 150,95 T 310,75 T 500,115" fill="none" stroke="#64748B" stroke-width="1" />\n    </svg>\n  </div>\n  <div class="flex items-center justify-between text-[10px] font-mono text-stone-400 pt-3 border-t border-stone-800 mt-2">\n    <span>Week 01 · Baseline</span>\n    <span>Week 12 · Terminal Convergence</span>\n  </div>\n</div>\n`,
    },
    {
      id: 'barcode_lollipop',
      name: 'Barcode Lollipop Almanac',
      category: 'Submersion',
      desc: 'Countable unit pins with waterline drop-lines and deficit immersion',
      html: `\n<!-- Lieflat Barcode Lollipop Almanac -->\n<div class="p-6 bg-[#0B223D] text-white rounded-3xl border border-sky-900 my-6 shadow-xl">\n  <div class="flex items-center justify-between border-b border-sky-800/60 pb-3 mb-4">\n    <div>\n      <span class="text-[10px] font-mono text-sky-400 font-bold uppercase tracking-wider">Porcelain Basics</span>\n      <h3 class="text-sm font-bold text-sky-50">One Almanac · Mastery Barcode</h3>\n    </div>\n    <span class="text-[10px] font-mono text-sky-300">849 Records Sampled</span>\n  </div>\n  <div class="h-28 relative flex items-center justify-around px-4">\n    <div class="absolute inset-x-0 top-1/2 border-b border-sky-400/40"></div>\n    <div class="flex flex-col items-center"><div class="w-3 h-3 rounded-full bg-sky-400 mb-1 ring-2 ring-sky-300/40"></div><div class="w-0.5 h-10 bg-sky-400"></div><span class="text-[9px] font-mono text-sky-300 mt-1">+1.8σ</span></div>\n    <div class="flex flex-col items-center"><div class="w-3 h-3 rounded-full bg-sky-400 mb-1 ring-2 ring-sky-300/40"></div><div class="w-0.5 h-12 bg-sky-400"></div><span class="text-[9px] font-mono text-sky-300 mt-1">+2.1σ</span></div>\n    <div class="flex flex-col items-center"><div class="w-3 h-3 rounded-full bg-sky-500 mb-1"></div><div class="w-0.5 h-6 bg-sky-500"></div><span class="text-[9px] font-mono text-sky-400 mt-1">+0.6σ</span></div>\n    <div class="flex flex-col items-center"><div class="w-0.5 h-8 bg-rose-500"></div><div class="w-3 h-3 rounded-full bg-rose-500 mt-1 ring-2 ring-rose-400/40"></div><span class="text-[9px] font-mono text-rose-400 mt-1">-1.2σ</span></div>\n    <div class="flex flex-col items-center"><div class="w-3 h-3 rounded-full bg-sky-400 mb-1"></div><div class="w-0.5 h-9 bg-sky-400"></div><span class="text-[9px] font-mono text-sky-300 mt-1">+1.4σ</span></div>\n  </div>\n  <div class="text-[10px] font-mono text-sky-400/80 text-center mt-2">Countable pins anchored at Waterline (Z = 0)</div>\n</div>\n`,
    },
    {
      id: 'glance_sprint',
      name: 'Glance Velocity Sprint',
      category: 'Submersion',
      desc: 'Conclusion-first ranking sprint with bold KPI stroke blocks',
      html: `\n<!-- Lieflat Glance Velocity Sprint -->\n<div class="p-6 bg-white rounded-3xl border border-stone-200 my-6 shadow-sm">\n  <div class="flex items-center justify-between pb-3 border-b border-stone-100 mb-4">\n    <span class="text-[10px] font-mono font-bold uppercase tracking-wider text-teal-700 bg-teal-50 px-2.5 py-0.5 rounded-full">Glance Sprint</span>\n    <span class="text-[10px] font-mono text-stone-400">Fast Reading · 0ms</span>\n  </div>\n  <div class="grid grid-cols-2 gap-3 mb-4">\n    <div class="p-3.5 bg-stone-50 rounded-2xl border border-stone-200">\n      <div class="text-[10px] font-mono text-stone-400 uppercase">Velocity Leader</div>\n      <div class="text-xl font-black text-stone-900 mt-0.5">+2.45 / wk</div>\n      <div class="text-[10px] text-emerald-600 font-semibold mt-0.5">Top Quartile (Q1)</div>\n    </div>\n    <div class="p-3.5 bg-stone-50 rounded-2xl border border-stone-200">\n      <div class="text-[10px] font-mono text-stone-400 uppercase">Immersion Deficit</div>\n      <div class="text-xl font-black text-rose-500 mt-0.5">14.2%</div>\n      <div class="text-[10px] text-rose-600 font-semibold mt-0.5">Below Waterline</div>\n    </div>\n  </div>\n  <div class="space-y-2">\n    <div class="p-2 bg-stone-50 rounded-xl flex items-center justify-between text-xs">\n      <span class="font-bold text-stone-800">#1 Grade 9 Bilingual STEM</span>\n      <div class="w-24 bg-stone-200 h-2 rounded-full overflow-hidden"><div class="bg-teal-500 h-2 rounded-full" style="width: 94%"></div></div>\n      <span class="font-mono text-emerald-600 font-bold">+2.45/wk</span>\n    </div>\n    <div class="p-2 bg-stone-50 rounded-xl flex items-center justify-between text-xs">\n      <span class="font-bold text-stone-800">#2 Grade 10 Humanities</span>\n      <div class="w-24 bg-stone-200 h-2 rounded-full overflow-hidden"><div class="bg-teal-500 h-2 rounded-full" style="width: 82%"></div></div>\n      <span class="font-mono text-teal-600 font-bold">+1.80/wk</span>\n    </div>\n  </div>\n</div>\n`,
    },
  ];
