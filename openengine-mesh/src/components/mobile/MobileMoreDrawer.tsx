    ...
    <div className="fixed inset-0 z-50 flex flex-col justify-end bg-black/50 backdrop-blur-xs animate-in fade-in duration-150">
      ...
      <div className="bg-white rounded-t-3xl max-h-[85vh] overflow-y-auto p-5 shadow-2xl border-t border-stone-200 space-y-5 animate-in slide-in-from-bottom-8 duration-200 pb-[calc(1.5rem+env(safe-area-inset-bottom))]">
        ...
        <div className="space-y-1.5">
          <div className="text-[10px] font-mono uppercase text-stone-400 px-1">Engineering Modules</div>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-xs font-bold">EDM Diagnostics</div>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-xs font-bold">Governance & SAIF</div>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-xs font-bold">Stats & Telemetry</div>
                <div className="text-[11px] text-stone-500">MTTM Velocity & Invariants</div>
              </div>
            </div>
            <ChevronRight className="w-4 h-4 text-stone-400" />
          </button>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-xs font-bold font-mono">TUI Shell</div>
                <div className="text-[11px] text-stone-500">Interactive Terminal Runner</div>
              </div>
            </div>
            <ChevronRight className="w-4 h-4 text-stone-400" />
          </button>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="text-xs font-bold">Consumer Portal</div>
                <div className="text-[11px] text-stone-500">Stakeholder App Preview & Desk</div>
              </div>
            </div>
            <ChevronRight className="w-4 h-4 text-stone-400" />
          </button>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-[11px] text-stone-500">System Preferences</div>
              </div>
            </div>
            <ChevronRight className="w-4 h-4 text-stone-400" />
          </button>
