...
export const DEFAULT_AI_PROVIDERS: AiProviderConfig[] = [
  ...
  {
    id: 'cluster_oecp',
    name: 'OpenEngine Cluster / vLLM',
    description: 'Distributed OECP cluster worker endpoints managed by zero-petri daemon.',
    endpointUrl: 'ws://127.0.0.1:8788/v1',
    status: 'connected',
    latencyMs: 8,
    activeModelId: 'openengine-cluster-worker-v1',
    selectedEffort: 'low',
    models: [
      {
        id: 'openengine-cluster-worker-v1',
        providerId: 'cluster_oecp',
        name: 'Cluster Worker v1',
        description: 'Shared worker pool over OpenEngine Cluster Protocol.',
        contextWindowTokens: 65536,
        maxOutputTokens: 16384,
        reasoningEffortSupported: false,
        costPer1mInputUsd: 0.00,
